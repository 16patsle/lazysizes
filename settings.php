...
class LazysizesSettings {
	...
	function ask_for_feedback() {
		?>
		<div class="updated">
			<p><?php _e( 'Help improve lazysizes: <a href="https://wordpress.org/support/plugin/lazysizes" target="_blank">submit feedback, questions, and bug reports</a>.', 'lazysizes' ); ?></p>
		</div>
		<?php
	...
	function lazysizes_action_links( $links ) {
		$links[] = '<a href="options-general.php?page=lazysizes">' . __( 'Settings', 'lazysizes' ) . '</a>';
		return $links;
	}
	...
	function lazysizes_general_render() {
		...
		<fieldset>
			<legend class="screen-reader-text">
				<span>
					<?php _e( 'Basic settings', 'lazysizes' ); ?>
				</span>
			</legend>
			<label for="lazysizes_minimize_scripts">
				...
				<?php _e( 'Load minimized versions of javascript and css files.', 'lazysizes' ); ?>
			</label>
			<br />
			<label for="lazysizes_footer">
				...
				<?php _e( 'Load scripts in the footer.', 'lazysizes' ); ?>
			</label>
		</fieldset>
		<fieldset>
			<legend class="screen-reader-text">
				<span>
					<?php _e( 'Lazy Load settings', 'lazysizes' ); ?>
				</span>
			</legend>
			<br />
			<label for="lazysizes_load_extras">
				...
				<?php _e( 'Lazy load YouTube and Vimeo videos, iframes, audio, etc.', 'lazysizes' ); ?>
			</label>
			<br />
			<label for="lazysizes_thumbnails">
				...
				<?php _e( 'Lazy load post thumbnails.', 'lazysizes' ); ?>
			</label>
			<br />
			<label for="lazysizes_textwidgets">
				...
				<?php _e( 'Lazy load text widgets.', 'lazysizes' ); ?>
			</label>
			<br />
			<label for="lazysizes_avatars">
				...
				<?php _e( 'Lazy load gravatars.', 'lazysizes' ); ?>
			</label>
			<br />
			<label for="lazysizes_excludeclasses">
				<?php _e( 'Skip lazy loading on these classes:', 'lazysizes' ); ?><br />
				...
				<p class="description">
					<?php _e( 'Prevent objects with the above classes from being lazy loaded. (List classes separated by a space and without the proceding period. e.g. "skip-lazy-load size-thumbnail".)', 'lazysizes' ); ?>
				</p>
			</label>
		</fieldset>
		<?php
	...
	function lazysizes_effects_render() {
		...
		<fieldset>
			<legend class="screen-reader-text">
				<span>
					<?php _e( 'Effects settings', 'lazysizes' ); ?>
				</span>
			</legend>
			<label for="lazysizes_fade_in">
				...
				<?php _e( 'Fade in lazy loaded objects.', 'lazysizes' ); ?>
			</label>
			<br />
			<label for="lazysizes_spinner">
				...
				<?php _e( 'Show spinner while objects are loading.', 'lazysizes' ); ?>
			</label>
		</fieldset>
		<?php
	...
	function lazysizes_addons_render() {
		...
		<fieldset>
			<legend class="screen-reader-text">
				<span>
					<?php _e( 'Addons settings', 'lazysizes' ); ?>
				</span>
			</legend>
			<label for="lazysizes_auto_load">
				...
				<?php _e( 'Automatically load all objects, even those not in view.', 'lazysizes' ); ?>
			</label>
			<br />
			<label for="lazysizes_aspectratio">
				...
				<?php _e( 'Keep original aspect ratio before the object is loaded.', 'lazysizes' ); ?>
				<p class="description">
					<?php _e( 'Currently this needs images to have a defined width and height. Make sure to set a size for the images in your posts.', 'lazysizes' ); ?>
				</p>
			</label>
		</fieldset>
		<?php
	...
	function lazysizes_basic_section_callback() {
		_e( 'Customize the basic features of lazysizes.', 'lazysizes' );
	}
	...
	function settings_page() {
		?>
		<div class="wrap">
			<h2><?php _e( 'lazysizes', 'lazysizes' ); ?></h2>
