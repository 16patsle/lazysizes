...
use Lazysizes\Vendor\Composer\Composer;
use Lazysizes\Vendor\Composer\Config;
use Lazysizes\Vendor\Composer\EventDispatcher\EventSubscriberInterface;
use Lazysizes\Vendor\Composer\IO\IOInterface;
use Lazysizes\Vendor\Composer\Package\AliasPackage;
use Lazysizes\Vendor\Composer\Package\Locker;
use Lazysizes\Vendor\Composer\Package\PackageInterface;
use Lazysizes\Vendor\Composer\Package\RootPackageInterface;
use Lazysizes\Vendor\Composer\Plugin\PluginInterface;
use Lazysizes\Vendor\Composer\Script\Event;
use Lazysizes\Vendor\Composer\Script\ScriptEvents;
use Generator;
...
final class Installer implements \Lazysizes\Vendor\Composer\Plugin\PluginInterface, \Lazysizes\Vendor\Composer\EventDispatcher\EventSubscriberInterface
{
...
PHP;
    public function activate(\Lazysizes\Vendor\Composer\Composer $composer, \Lazysizes\Vendor\Composer\IO\IOInterface $io)
    {
        // Nothing to do here, as all features are provided through event listeners
    }
    public function deactivate(\Lazysizes\Vendor\Composer\Composer $composer, \Lazysizes\Vendor\Composer\IO\IOInterface $io)
    {
        // Nothing to do here, as all features are provided through event listeners
    }
    public function uninstall(\Lazysizes\Vendor\Composer\Composer $composer, \Lazysizes\Vendor\Composer\IO\IOInterface $io)
    {
        // Nothing to do here, as all features are provided through event listeners
    }
    /**
    ...
    {
        return [\Lazysizes\Vendor\Composer\Script\ScriptEvents::POST_AUTOLOAD_DUMP => 'dumpVersionsClass'];
    }
    /**
     * @throws RuntimeException
     */
    public static function dumpVersionsClass(\Lazysizes\Vendor\Composer\Script\Event $composerEvent)
    {
     ...
     * @throws RuntimeException
     */
    private static function writeVersionClassToFile(string $versionClassSource, \Lazysizes\Vendor\Composer\Composer $composer, \Lazysizes\Vendor\Composer\IO\IOInterface $io)
    {
     ...
     * @throws RuntimeException
     */
    private static function locateRootPackageInstallPath(\Lazysizes\Vendor\Composer\Config $composerConfig, \Lazysizes\Vendor\Composer\Package\RootPackageInterface $rootPackage) : string
    {
    ...
    private static function getRootPackageAlias(\Lazysizes\Vendor\Composer\Package\RootPackageInterface $rootPackage) : \Lazysizes\Vendor\Composer\Package\PackageInterface
    {
        $package = $rootPackage;
        while ($package instanceof \Lazysizes\Vendor\Composer\Package\AliasPackage) {
     ...
     */
    private static function getVersions(\Lazysizes\Vendor\Composer\Package\Locker $locker, \Lazysizes\Vendor\Composer\Package\RootPackageInterface $rootPackage) : \Generator
    {
