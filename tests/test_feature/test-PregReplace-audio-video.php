...
class Tests_PregReplace_AudioVideo extends WP_UnitTestCase {
	...
	public function test_preg_replace_html_audio_src_attr() {
		$markup   = $this->class_instance->preg_replace_html( '<audio src="sound.mp3"></audio>', [ 'audio' ] );
	...
	public function test_preg_replace_html_video_src_attr() {
		$markup   = $this->class_instance->preg_replace_html( '<video src="vid.mp4" poster="img.png"></video>', [ 'video' ] );
	...
	public function test_preg_replace_html_video_source_elem() {
		...
		';
		$markup   = $this->class_instance->preg_replace_html( $html, [ 'video' ] );
		$expected = '
